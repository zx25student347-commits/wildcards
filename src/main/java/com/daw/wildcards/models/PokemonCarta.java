...
public class PokemonCarta extends Carta {
    ...
    public PokemonCarta(Juego juego, CartaSet set, String nombre, String numeroCarta, String rareza, String tipo,
            String descripcion, String imagenUrl, Integer hp, String pokemonTipo, String fase, String evolucionaDe,
            String ataques, String debilidad, String resistencia, String costeRetirada) {
